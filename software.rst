...
DASmetaeditor
------------------------
A web-based JSON editor and validator for Distributed Acoustic Sensing (DAS)
metadata, following the FDSN DAS metadata standard.

https://git.gfz-potsdam.de/geofon/DASmetaeditor
